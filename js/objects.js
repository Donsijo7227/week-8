...
const person ={
    ...
    age: 21,
    interests : ["camping","skiing","canoeing"],
    greeting(){
      //  alert(`hi, i'm ${this.name} and i am ${this.age} years old.`);
        //let greeting = `hi, i'm ${this.name.} and i am ${this.age} years old, and i enjoy ${this.interests[2]}.`;
        let greeting = `hi, i'm ${this.name.first} ${this.name.last} and i am ${this.age} years old, and i enjoy ${this.interests[2]}.`;
        return greeting;
    }
};
